...
public class Main {
    ...
    public static AVLTree generateTree3() {
        AVLTree tree = new AVLTree();
        int[] keyList = { 21, 8, 34, 3, 16, 26, 42, 2, 5, 11, 18, 23, 31, 37, 47, 1, 4, 6, 9, 13, 17, 19, 22, 24, 28,
                33, 35, 40, 45, 52, 7, 10, 12, 14, 20, 25, 27, 30, 32, 36, 38, 41, 43, 46, 49, 53, 15, 29, 39, 44, 48,
                51, 54, 50 };
        for (int i = 0; i < keyList.length; i++) {
            if (i == 0) {
                tree.root = new Node(keyList[i]);
    ...
    public static void main(String[] args) {
         ...
         * tree.doubleRotateFromRight(tree.find(8)); tree.printTree();
         */
        /*
         * tree = Main.generateTree1();
         * System.out.println("---- Test8 doubleRotateFromLeft at Lv 1 ----");
         * tree.doubleRotateFromLeft(tree.find(8)); tree.printTree();
         */
        /*
         * tree = Main.generateTree1(); tree.printTree();
         * System.out.println("---- Test9.1 doubleRotateFromLeft at Lv 2 ----");
         * tree.doubleRotateFromLeft(tree.find(4)); tree.printTree();
         * System.out.println("---- Test9.2 doubleRotateFromLeft at Lv 2 ----");
         * tree.doubleRotateFromLeft(tree.find(12)); tree.printTree();
         */

        /*
         * tree = Main.generateTree1(); tree.printTree();
         * System.out.println("---- Test10.1 doubleRotateFromRight at Lv 2 ----");
         * tree.doubleRotateFromRight(tree.find(4)); tree.printTree();
         * System.out.println("---- Test10.2 doubleRotateFromRight at Lv 2 ----");
         * tree.doubleRotateFromRight(tree.find(12)); tree.printTree();
         */
        ...
        /*
         * BSTree tree1 = new BSTree(); int[] keyList = {3, 2, 5, 1, 4, 8, 7, 6}; for
         * (int i=0; i<keyList.length; i++) tree1.insert(keyList[i]); tree1.printTree();
         * 
         * BSTree tree2 = new BSTree(); keyList = new int[]{9, 11, 10}; for (int i=0;
         * i<keyList.length; i++) tree2.insert(keyList[i]); tree2.printTree();
         * 
         * //tree2.merge(tree1); //tree2.printTree(); tree1.merge(tree2);
         * tree1.printTree();
         */
        ...
        // for (int i = 0; i < 4; i++)
        // tree.insert(i + 1); // This should be splaying insert tree.printTree();

        // Node node;

        // System.out.println("Zig Node (1)");
        // node = tree.find(1, false); // false
        // // means do not splay the node tree.zig(node); tree.printTree();

        // System.out.println("Zig Node (3)");
        // node = tree.find(3, false); // false
        // // means do not splay the node tree.zig(node); // This should change the tree
        // // structure tree.printTree();

        // System.out.println("Zig Node (2)");
        // node = tree.find(2, false); // false
        // // means do not splay the node tree.zig(node); // This should change the tree
        // // structure tree.printTree();

        // System.out.println("Zig Node (4)");
        // node = tree.find(4, false); // false
        // // means do not splay the node tree.zig(node); // This should change the tree
        // // structure tree.printTree();
        ...
        // // This should be splaying insert tree.printTree();

        // Node node1, node2, node3, node5, node7; // This find(key, false) means do not
        // // splay the node
        ...
        /*
         * BSTree2 tree1 = new BSTree2(); long start = System.currentTimeMillis(); int N
         * = 50000; for (int i = 0; i < N; i++) tree1.insert(i);
         ...
         * (System.currentTimeMillis() - start) + " msec"); SplayTree tree2 = new
         * SplayTree(); start = System.currentTimeMillis(); for (int i = 0; i < N; i++)
         * tree2.insert(i);
         * 
         * System.out.println("Time for sequentially inserting " + N +
         * " objects into SplayTree = " + (System.currentTimeMillis() - start) +
         * " msec"); start = System.currentTimeMillis(); for (int i = 0; i < N; i++)
         * tree2.find((int)(Math.random() * N ), true);
         * System.out.println("Time for finding " + N +
         * " different objects in SplayTree = " + (System.currentTimeMillis() - start) +
         * " msec");
         * 
